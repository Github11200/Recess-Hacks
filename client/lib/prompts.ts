...
- Make sure that for fields like education that require an array of objects that you ARE NOT giving it a stringified JSON object because then the schema won't match. Instead just output everything in actual json, don't stringify anything. Also make
sure things like arrays that you don't forget commas because then I can do JSON.parse().
